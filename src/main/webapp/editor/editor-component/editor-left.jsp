...
<div class="behind-left">
	...
	<ul class="beind-menu layui-nav layui-nav-tree " lay-filter="test">
	  ...
	  <li class="layui-nav-item"><a href="<%=request.getContextPath()%>/manager-article/show-form?flag=insert"><i class="iocfont">&#xe659;</i>文章发布</a></li>

	  <li class="layui-nav-item">
	    <a><i class="iocfont">&#xe7c0;</i>管理</a>
	    <dl class="layui-nav-child">
	      <dd><a href="<%=request.getContextPath()%>/manager-article/article-tab">文章管理</a></dd>
